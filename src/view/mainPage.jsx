...
const MainPage = () => {
  ...
  //changing the icon based on the weather state
  ...
  //changing the background based on the weather state
  ...
  //handling submit and fetching the data
  ...
  return (
    <>
      {/* the hero section and displaying all infos */}
      <motion.section
        key={bgImg}
      ...
      >
        <div className="w-[50%] h-screen flex flex-col">
          ...
          {weather && (
            ...
            >
              <h1 className="text-[150px] text-white ">
                {weather.main.temp}°{" "}
              </h1>
              <div className="w-80 h-40 text-center p-4 flex flex-col">
                <h1 className="text-[30px] text-white ">{weather.name}</h1>
          ...
          >
            <div className="w-[85%] px-10 h-full flex items-end">
              <input
                ...
                className="border-b text-3xl pl-5 placeholder:text-3xl border-gray-700 w-full h-[40%] outline-none bg-transparent"
              />
            </div>
            <button
              type="submit"
              className="w-[15%] h-full flex relative justify-center items-center bg-white cursor-pointer"
            >
